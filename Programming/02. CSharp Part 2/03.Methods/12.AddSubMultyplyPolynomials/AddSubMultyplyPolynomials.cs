...
using System;
class AddSubMultyplyPolynomials
{
    static void Main()
    {
        ...
        OperationsWithPolynomials(firstPolynom, secondPolynom);

    }

    /// <summary>
    /// Method that make's the choise of the operation!
    /// </summary>
    /// <param name="firstPolynom">String of the first polynomial.</param>
    /// <param name="secondPolynom">String of the second polynomial.</param>
    public static void OperationsWithPolynomials(string firstPolynom, string secondPolynom)
    {
        int[] result;

        // enter the operation you want to make with these polynomials
        ...
        {
            case '+':
                // adding tho polynomials to each other.
                result = AddPolynomials(firstPolynom, secondPolynom, +1);
                break;
            case '-':
                // substracting the second polynomial to the first polynomial
                result = AddPolynomials(firstPolynom, secondPolynom, -1);
                break;
            case '*':
                // multyplq the polynomials
                result = AddPolynomials(firstPolynom, secondPolynom, 0);
                break;
            default:
