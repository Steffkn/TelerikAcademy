namespace Cars.Tests.JustMock.Mocks
{
    ...
    public class JustMockCarsRepository : CarRepositoryMock, ICarsRepositoryMock
    {
        protected override void ArrangeCarsRepositoryMock()
        {
            ...
            //Mocks.Arrange(() => this.CarsData.GetById(-1).Returns(this.FakeCarCollection.Where(c => c.Id == -1).FirstOrDefault());
            
            //Mocks.Arrange(() => this.CarsData.SortedByMake().Returns(this.FakeCarCollection.OrderBy(c => c.Make).ToList());
            //Mocks.Arrange(() => this.CarsData.SortedByYear().Returns(this.FakeCarCollection.OrderBy(c => c.Year).ToList());
        }
    }
}
