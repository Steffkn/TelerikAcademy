    ...
    static void Main()
    {
        ...
        if( double.TryParse(Console.ReadLine(), out a) )
        {
            ...
            if( double.TryParse(Console.ReadLine(), out b) )
            {
                ...
                {
                    // if c is not a valid number we will see this line at the console
                    Console.WriteLine("Invalid input for \"c\"! (Numbers only)");
                }
            }
            else
            {
                // if b is not a valid number we will see this line at the console
                Console.WriteLine("Invalid input for \"b\"! (Numbers only)");
            }
        }
        else
        {
            // if a is not a valid number we will see this line at the console
